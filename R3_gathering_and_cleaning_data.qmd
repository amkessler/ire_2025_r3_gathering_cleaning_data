---
title: "Musk and the European Far Right"
author: "AP Data & Investigative Teams"
date: "06/20/2025"
...
-   Get data from packages the R community has built to load and work with specific kinds of data, including some nice helper functions. If the dataset you want to use is popular, there's a great change someone has built an R package for it! Some great examples: [*Tidycensus*](https://walkerke.github.io/tidycensus/index.html)*: for loading and working with all manner of U.S. Census Data.* [RTweet](https://rtweet.info/): for working with Twitter data
...
Uncomment this out and then try to run it...
...
For columns that contain only numbers, it puts an x at the start of the name, 
so now we can get to cleaning 2015.
